...
commands =
  ["abandon_heresy","abdicate","abdicate_to","abdicate_to_most_liked_by",
   ...
   "check_variable", "is_variable_equal", -- These should probably be conditions
   ...
   "hold_election","if","impregnate","impregnate_cuckoo","imprison",
...
stringyCommands =   [
   ...
   "add_building","add_objective","approve_law","banish_religion","cancel_job_action",
   ...
   "remove_settlement","remove_spouse","remove_title",
